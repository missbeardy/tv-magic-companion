...
describe('theme', () => {
  it('org colors override brand defaults', () => {
    const tokens = resolveThemeTokens(
      ...
      { id: '1', name: 'TV Magic', slug: 'tv-magic', vertical: 'x', logo_url: null, primary_color: '#004B93', secondary_color: '#00B4C5', sms_templates: {}, ai_config: {}, upsell_items: [], is_active: true }
    )
  ...
  it('falls back to brand when org colors missing', () => {
    const tokens = resolveThemeTokens(
      ...
      { id: '1', name: 'Brand', slug: 'b', vertical: 'x', logo_url: '/logo.png', primary_color: '#111111', secondary_color: '#222222', sms_templates: {}, ai_config: {}, upsell_items: [], is_active: true }
    )
